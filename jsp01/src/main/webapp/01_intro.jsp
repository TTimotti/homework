    ...
    JSP : Java Server Page
        ...
        JSP 구성 요소(태그)
          1. 지시문 (directive) : <%@ ... %>
              ...
              JSP 설정.
          2. 선언문 (declaration) : <%! ... %>
             JSP가 Java 파일로 변환될 때, 필드(멤버 변수)와 메서드 정의
          3. 스크립트 릿 (scriptlet) : <% ... %>
             JSP가 Java 파일로 변환될 때, _jspService(request, response) 메서드 안에 포함되는 코드
